...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      client.publish("debug", "ESP32 2.3 connected");
      // ... and resubscribe
      client.subscribe("notice_r");
      client.subscribe("weather_r");
      //client.subscribe("msi_info");
      client.subscribe("to_temperature_r");
      client.subscribe("to_humidity_r");
      client.subscribe("to_pressure_r");
