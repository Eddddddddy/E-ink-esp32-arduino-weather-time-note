...
void button_handle(uint8_t gpio)
{
    ...
    case BUTTON_2: {
        ...
        if(page_state==3){
            ...
            display.fillRect(101, 0, 170, 127, GxEPD_WHITE);
            display.updateWindow(101, 0, 170, 127, true);
//            display.fillRect(101, 0, 170, 127, GxEPD_BLACK);
//            display.updateWindow(101, 0, 170, 127, true);
        }
...
#endif
    if ((const char *)root["notice_1"] == NULL) {
        return false;
    }
...
void secondPage(){
  display.fillRect(101, 0, 170, 127, GxEPD_WHITE);
  display.fillRect(111, 42, 150, 2, GxEPD_BLACK);
  display.fillRect(111, 86, 150, 2, GxEPD_BLACK);
  ...
  u8g2_for_adafruit_gfx.print(notice_str.notice_1);
  u8g2_for_adafruit_gfx.setCursor(111, 61);
...
void timerRec(){
  if(page_state==1){
    LCD_print();
    display.updateWindow(115, 16, 141, 59, true);
  }
}
...
bool bme680_read(){
    ...
    bme680_str.temperature=bme.readTemperature();
...
//            battery_adc=0;
//            adc_data=adcEnd(35);
//            Serial.println(adc_data* 0.0008 +0.1383);
//            display.fillRect(200,70,50,50,GxEPD_WHITE);
//            u8g2_for_adafruit_gfx.setForegroundColor(GxEPD_BLACK);
//            u8g2_for_adafruit_gfx.setCursor(200, 100);
//            u8g2_for_adafruit_gfx.print(adc_data);
//            display.updateWindow(0, 0, GxEPD_WIDTH, GxEPD_HEIGHT, false);
//            timer_2_battery=0;
//        }
    }
